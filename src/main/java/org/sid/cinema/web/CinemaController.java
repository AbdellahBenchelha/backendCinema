...
import org.sid.cinema.service.ICinemaInititService;
...
public class CinemaController {
    ...
    @Autowired
    public ICinemaInititService projectionService;
   
    @GetMapping(path = "/index")
    public String index(){
    	return "index";
    }
    public CinemaController(ProjectionRepository projectionRepository) {
   ...
   /*@GetMapping(path = "/listeProjections")
    ...
    public String customersPage(HttpServletRequest request, Model model) {
        ...
        model.addAttribute("listeProjections", projectionRepository.findAll(PageRequest.of(page, size)));
        
        return "listeProjections";
    }
	 

    @GetMapping(path = "/deleteTProjections")
